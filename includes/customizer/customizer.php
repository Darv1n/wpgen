...
function wpgen_customize_register( $wp_customize ) {
	...
	//	Add Sections
	//	Добавляем разделы с настройками
	...
	//	Переменные с описанием для опций
	...
	//$front_page_columns_description = __( 'Choose how many columns to display posts on index page', 'wpgen' );
	...
	$other_tab_social_list_description = 'Add a link to social-list networks using a shortcode <strong>[wpgen-social-list]</strong>';
	$other_tab_contacts_list_description = 'Add a link to contacts-list using a shortcode <strong>[wpgen-contacts-list]</strong> or single <strong>[wpgen-email]</strong>, <strong>[wpgen-phone]</strong>, <strong>[wpgen-address]</strong>';
