...
if( !function_exists( 'get_selected_font' ) ) {
	function get_selected_font( $string = null ) {
		...
		$converter = array(
			'open-sans' => __( 'Open Sans', 'wpgen'),
			'montserrat' => __( 'Montserrat', 'wpgen' ),
			'oswald' => __( 'Oswald', 'wpgen'),
			'raleway' => __( 'Raleway', 'wpgen'),
			'roboto-slab' => __( 'Roboto Slab', 'wpgen'),
			'playfair-display' => __( 'Playfair Display', 'wpgen' ),
			'lora' => __( 'Lora', 'wpgen'),
			'bitter' => __( 'Bitter', 'wpgen'),
			'comfortaa' => __( 'Comfortaa', 'wpgen'),
			'jost' => __( 'Jost', 'wpgen' ),
			'vollkorn' => __( 'Vollkorn', 'wpgen'),
			'alegreya' => __( 'Alegreya', 'wpgen'),
			'literata' => __( 'Literata', 'wpgen'),
			'podkova' => __( 'Podkova', 'wpgen'),
			'brygada-1918' => __( 'Brygada 1918', 'wpgen'),
			'piazzolla' => __( 'Piazzolla', 'wpgen'),
			
			'merriweather' => __( 'Merriweather', 'wpgen'),
			'pt-serif' => __( 'PT Serif', 'wpgen'),
			'source-serif-pro' => __( 'Source Serif Pro', 'wpgen'),
			'cormorant' => __( 'Cormorant', 'wpgen'),
			'anonymous-pro' => __( 'Anonymous Pro', 'wpgen'),
			'bona-nova' => __( 'Bona Nova', 'wpgen'),
			'cormorant' => __( 'Cormorant', 'wpgen'),
		);
