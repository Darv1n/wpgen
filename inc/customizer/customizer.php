...
add_action( 'customize_register', 'wpgen_customize_register' ); // enqueue register section and fields.
add_action( 'customize_preview_init', 'wpgen_customize_preview_js' ); // enqueue customizer scripts.
add_action( 'customize_controls_enqueue_scripts', 'wpgen_customize_panels_js' ); // enqueue customizer scripts.

if ( ! function_exists( 'wpgen_customize_register' ) ) {
...
if ( ! function_exists( 'wpgen_customize_partial_blogname' ) ) {
...
if ( ! function_exists( 'wpgen_customize_partial_blogdescription' ) ) {
...
if ( ! function_exists( 'wpgen_customize_partial_blogdescription' ) ) {
	...
	function wpgen_customize_preview_js() {
		// wp_enqueue_style( 'wpgen-customizer-ui-css', get_theme_file_uri( '/assets/css/customizer-ui.css' ) ); // This file doesn't exists.
...
if ( ! function_exists( 'wpgen_customize_panels_js' ) ) {

	/**
	 * Load dynamic logic for the customizer controls area.
	 */
	function wpgen_customize_panels_js() {
